...
class LinearTest(parameterized.TestCase):
    def test_dense(self):
        ...
        onp.testing.assert_allclose(y, onp.full((1, 4), 4.0))
    ...
    def test_dense_extra_batch_dims(self):
        ...
        y, _ = dense_module.init(rng, x)
        onp.testing.assert_allclose(y, onp.full((1, 2, 4), 4.0))
    ...
    def test_dense_no_bias(self):
        ...
        y, _ = dense_module.init(rng, x)
        onp.testing.assert_allclose(y, onp.full((1, 4), 3.0))
    ...
    def test_dense_general_two_out(self):
        ...
        onp.testing.assert_allclose(y, onp.full((1, 2, 2), 4.0))
    ...
    def test_dense_general_two_in(self):
        ...
        y, _ = dg_module.init(rng, x)
        onp.testing.assert_allclose(y, onp.full((1, 3), 5.0))
    ...
    def test_dense_general_batch_dim(self):
        ...
        target = onp.concatenate(
            [onp.full((1, 1, 7), 16.0), onp.full((1, 1, 7), 31.0)], axis=0
        )
    ...
    def test_dense_general_vs_numpy(self, axis, batch_dims, einsum_expr):
        ...
        target = onp.einsum(einsum_expr, x, dg_module.params["kernel"]) + 1.0
    ...
    def test_conv(self, kernel_size):
        ...
        onp.testing.assert_allclose(y, onp.full((1, 6, 4), 10.0))
    ...
    def test_single_input_conv(self, kernel_size):
        ...
        model = nn.Model(conv_module, initial_params)
        self.assertEqual(model.params["kernel"].shape, (3, 3, 4))
        onp.testing.assert_allclose(y, onp.full((6, 4), 10.0))
    ...
    def test_group_conv(self, kernel_size):
        ...
        onp.testing.assert_allclose(y, onp.full((1, 6, 4), 7.0))
    ...
    def test_embed(self):
        ...
        onp.testing.assert_allclose(z, 3.0 * jnp.arange(4))
