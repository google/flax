...
class TransformTest(absltest.TestCase):
  ...
  def test_vmap_decorated(self):
    ...
    def vmap(fn):
      return nn.vmap(
          fn, in_axes=(0,), variable_axes={'params': None}, split_rngs={'params': False}
      )
  ...
  def test_vmapped_outer_module(self):
    ...
    self.assertEqual(init_vars['params']['outer']['Dense_0']['kernel'].shape, (3, 2, 5))
    self.assertEqual(init_vars['params']['outer']['Dense_0']['bias'].shape, (3, 5))
  ...
  def test_nested_module_args_vmap(self):
    ...
    class C(nn.Module):
      ...
      @partial(nn.vmap, variable_axes={'params': 0}, split_rngs={'params': True})
      @nn.compact
      def __call__(self, x):
        return self.B(x)
    ...
    self.assertEqual(variable_shapes['params']['A_0']['Dense_0']['kernel'], (10, 10, 3))
    self.assertEqual(variable_shapes['params']['A_0']['Dense_0']['bias'], (10, 3))
  ...
  def test_nested_module_args_vmap_2(self):
    ...
    self.assertEqual(variable_shapes['params']['A_0']['Dense_0']['kernel'], (10, 10, 3))
    self.assertEqual(variable_shapes['params']['A_0']['Dense_0']['bias'], (10, 3))
    self.assertEqual(variable_shapes['params']['A_1']['Dense_0']['kernel'], (10, 10, 3))
    self.assertEqual(variable_shapes['params']['A_1']['Dense_0']['bias'], (10, 3))
  ...
  def test_toplevel_submodule_adoption_transform(self):
    ...
    Ctrafo = nn.vmap(Csimple, variable_axes={'params': 0}, split_rngs={'params': True})
  ...
  def test_partial_module_method(self):
    ...
    class Foo(nn.Module):
      ...
      def __call__(self, x):
        return nn.vmap(
            partial(Foo.inner), variable_axes={'params': 0}, split_rngs={'params': True}
        )(self, x)
  ...
  def test_while_loop(self):
    ...
    np.testing.assert_array_compare(
        operator.__ne__, vars['state']['rng_loop'][0], vars['state']['rng_loop'][1]
    )
