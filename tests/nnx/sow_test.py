...
from flax.nnx.sow import sow, capture, _prefix
...
def test_nested_names():
  ...
  _, collected = capture(f)(jnp.float32(1.0))
  assert collected["top"] == (1.0,)
  assert collected["inner"]["a"] == (2.0,)
  assert collected["inner"]["b"] == (3.0,)
