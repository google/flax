...
def bin_and_batch(
    ...
    if buckets is None:
        ...
        bucket_boundaries = [
            target_bucket_length // 4,
            target_bucket_length // 2,
            target_bucket_length,
            target_bucket_length * 2,
            target_bucket_length * 4,
            target_bucket_length * 8,
...
def get_lm1b_datasets(
    ...
    (train_data, eval_data, features_info, keys) = train_and_eval_dataset(
        "lm1b/subwords32k", data_dir, train_shuffle_files=True, eval_shuffle_files=False
    )
