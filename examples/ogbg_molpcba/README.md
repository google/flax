...
-------- | ---------- | ------------- | ------- | ------- | ---------------
1x V100  | 256        |   2h58m       | 0.249   | 0.257   |[2021-08-03](https://tensorboard.dev/experiment//)
...
We found that the addition of [virtual nodes](https://arxiv.org/abs/1709.03741),
which are connected to all nodes in each graph, did not improve performance.
