...
from .. import jax_utils, serialization, struct, traverse_util
...
class Optimizer(struct.PyTreeNode):
    ...
    def unreplicate(self):
        ...
        if not isinstance(self.optimizer_def, ReplicatedOptimizer):
            raise ValueError(
                "Cannot unreplicate an optimizer " "that is not replicated."
            )
...
serialization.register_serialization_state(
    Optimizer, Optimizer.state_dict, Optimizer.restore_state, override=True
)
