...
class Cache(Collection):
    ...
    def initialize_cache(self, shape, dtype=None):
        ...
        def _init(shape_data):
            ...
            return _CacheEntry(
                key=jnp.zeros(full_shape, dtype=dtype),
...
jax.tree_util.register_pytree_node(Cache, iterate_collection, collection_from_iterable)
...
class MultiHeadDotProductAttention(Module):
    ...
    def apply(
        ...
        query, key, value = (
            dense(inputs_q, dtype=dtype, name="query"),
