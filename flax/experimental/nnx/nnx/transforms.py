...
class JITOptions:
  ...
  def from_jit_kwargs(
    ...
    if static_argnums is None:
      ...
      _static_argnums = (static_argnums,)
    else:
      _static_argnums = tuple(static_argnums)
    _static_argnames: tuple[str, ...]
    if static_argnames is None:
      _static_argnames = ()
    elif isinstance(static_argnames, str):
      _static_argnames = (static_argnames,)
    else:
      _static_argnames = tuple(static_argnames)
    _donate_argnums: tuple[int, ...]
    if donate_argnums is None:
      _donate_argnums = ()
    elif isinstance(donate_argnums, int):
      _donate_argnums = (donate_argnums,)
    else:
      _donate_argnums = tuple(donate_argnums)
    _donate_argnames: tuple[str, ...]
    if donate_argnames is None:
      _donate_argnames = ()
    elif isinstance(donate_argnames, str):
      _donate_argnames = (donate_argnames,)
    else:
      _donate_argnames = tuple(donate_argnames)
