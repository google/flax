...
class GraphDef(tp.Generic[Node]):
  """A class that represents all the static, stateless, and Pythonic parts of a
  :class:`flax.nnx.Module`. An ``nnx.GraphDef`` can be generated by either calling
  :func:`flax.nnx.split` or :func:`flax.nnx.graphdef` on the :class:`flax.nnx.Module`."""
