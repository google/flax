...
class BwdFn:
  ...
  def __call__(self, *args):
    ...
    *nondiff, pure_residual, (pure_args_out_g, pure_out_g) = args
    ...
    def state_to_tree_node(path, is_tree_node: bool, x):
      arg_num = path[-1]
      assert isinstance(arg_num, jax.tree_util.SequenceKey)
      if isinstance(x, State) or arg_num in metadata.nondiff_argnums:
    ...
    pure_tangent = jax.tree_util.tree_map_with_path(
      state_to_tree_node,
