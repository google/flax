...
class Lowered(Stage):
  ...
  def from_flat_info(
    cls,
    lowering: jax._src.stages.XlaLowering,
  ...
  def compile(
    self, compiler_options: jax._src.stages.CompilerOptions | None = None
  ) -> Compiled:
