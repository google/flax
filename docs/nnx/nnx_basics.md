...
some syntactic overhead. `Module`s and other `Object`-derived types as PyTrees
via the `unsafe_pytree` class argument for convenience. This allows you to
pass Modules directly to JAX functions without having to split them first.
